...
const baseRules = [
    ...
    `RULE-SET,StaticResources,全球加速`,
    `RULE-SET,CDNResources,全球加速`,
    `RULE-SET,AdditionalCDNResources,全球加速`,
    `RULE-SET,Crypto,全球加速`,
    `RULE-SET,EHentai,全球加速`,
...
function main(config) {
    const excludePattern = /官网|雨燕云|ios设备请升级软件/i; 
    if (config.proxies) {
